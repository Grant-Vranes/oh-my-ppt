  ...
  return (
    <ToolRowShell>
      ...
      <button
        type="button"
        disabled={disabled}
        className="inline-flex h-7 shrink-0 items-center gap-1.5 rounded-full border border-[#e4e4e7]/70 bg-[#ffffff]/88 px-2.5 text-[10px] font-bold leading-none text-[#314028] shadow-[inset_0_1px_2px_rgba(0,0,0,0.03)] transition-colors hover:bg-[#f3f7ed] disabled:cursor-not-allowed disabled:opacity-50"
        onClick={() => {
