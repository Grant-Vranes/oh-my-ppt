    ...
    <Card className="mb-4">
        ...
        <div>
          <CardTitle className="flex items-center gap-1.5 text-base">
            ...
            <Popover>
              ...
              >
                <p className="mb-2 text-[11px] font-semibold text-[#18181b]">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {MODEL_PROVIDER_LINKS.map((item) => (
                    <a
                      ...
                      className="rounded-md border border-[#e4e4e7]/80 bg-[#f5efe2]/60 px-2 py-1 text-[11px] text-[#5b6b4d] transition-colors hover:border-[#96b77f]/60 hover:bg-[#e8f0de] hover:text-[#18181b]"
                    >
                      {item.label}
                    </a>
                  ))}
      ...
      <CardContent className="space-y-2.5 p-5 pt-0">
        {modelConfigs.length === 0 ? (
          <div className="rounded-lg border border-dashed border-[#e4e4e7]/85 bg-[#ffffff]/70 p-6 text-sm text-muted-foreground">
            {t('settings.noModels')}
          </div>
        ) : (
            ...
            <div
              ...
              className={
                config.active
                  ...
                  : 'flex flex-col gap-3 rounded-lg border border-[#e4e4e7]/80 bg-[#ffffff]/78 p-3 sm:flex-row sm:items-center sm:justify-between'
              }
            >
