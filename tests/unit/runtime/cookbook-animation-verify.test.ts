...
describe('cookbook animation verification', () => {
  ...
  const entranceTests: Array<{ type: string; extra?: string; expectParams: Record<string, unknown> }> = [
    ...
    { type: 'slide-up', expectParams: { opacity: [0, 1], translateY: [40, 0] } },
    { type: 'slide-down', expectParams: { opacity: [0, 1], translateY: [-40, 0] } },
    { type: 'slide-left', expectParams: { opacity: [0, 1], translateX: [40, 0] } },
    { type: 'slide-right', expectParams: { opacity: [0, 1], translateX: [-40, 0] } },
    { type: 'zoom-in', expectParams: { opacity: [0, 1], scale: [0.75, 1] } },
    { type: 'spin-in', expectParams: { opacity: [0, 1], rotate: [-12, 0], scale: [0.92, 1] } },
    { type: 'fly-in', extra: 'data-anim-from="left"', expectParams: { opacity: [0, 1], translateX: [-40, 0] } },
    { type: 'fly-in', extra: 'data-anim-from="right"', expectParams: { opacity: [0, 1], translateX: [40, 0] } },
    { type: 'fly-in', extra: 'data-anim-from="top"', expectParams: { opacity: [0, 1], translateY: [-40, 0] } },
    { type: 'fly-in', extra: 'data-anim-from="bottom"', expectParams: { opacity: [0, 1], translateY: [40, 0] } },
