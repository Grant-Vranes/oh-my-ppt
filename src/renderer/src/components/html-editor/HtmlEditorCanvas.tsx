...
`
  ...
  return (
    <div ref={rootRef} className="relative h-full w-full rounded-[inherit] bg-[#ffffff]">
      <div
        ref={containerRef}
      ...
      {webviewSrc && !webviewReady ? (
        <div
          className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-5 bg-[#ffffff] text-[#7c786b]"
          aria-busy="true"
          aria-live="polite"
        >
