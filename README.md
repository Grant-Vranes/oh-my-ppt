...
- 🎨 **内置 70+ 风格SKILL** — 极简白、赛博霓虹、包豪斯、日式简约、小红书白… 也支持自定义风格
...
- 📄 **多格式导出** — 支持 PDF、批量 PNG、PNG 长图、MP4 视频，并提供可编辑 PPTX 导出
...
> 💡 选择创作方式 → 确认主题 / 资料 / 页数 / 尺寸格式 / 风格 / 字体 → AI 生成 HTML 演示稿 → 预览、演示、编辑 → 生成演讲稿 → 导出 PDF / PNG / PNG 长图 / PPTX / MP4 / HTML 打包文件

首页支持几种常用入口：

- **一句话创建**：直接填写主题、尺寸格式和详细描述，快速生成一份完整演示稿、竖版内容、方图或小红书图文。
