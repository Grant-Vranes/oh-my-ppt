...
export function ChartInspector({ draft, onDraftChange }: ElementEditorProps): React.JSX.Element {
  ...
  const renderToggleField = (
    ...
    <label className="flex items-center justify-between gap-3 rounded-[9px] border border-[#d9cfbd]/72 bg-[#ffffff]/82 px-2.5 py-2">
      ...
      <div className="space-y-2.5">
        ...
        <div className="block space-y-1.5">
              ...
              <TooltipTrigger asChild>
                <span className="inline-flex">
                  <button
                    ...
                    className="inline-flex h-7 items-center gap-1.5 rounded-full border border-[#d9cfbd]/78 bg-[#ffffff]/88 px-2.5 text-[11px] font-medium text-[#5d6b4d] transition-colors hover:border-[#9daf8a] hover:text-[#415235] disabled:cursor-not-allowed disabled:opacity-55"
                  >
          ...
          <textarea
            ...
            className="min-h-[138px] w-full resize-y rounded-[9px] border border-[#d9cfbd]/72 bg-[#ffffff]/92 px-2.5 py-2 font-mono text-[11px] leading-5 text-[#34402c] outline-none transition-colors placeholder:text-[#b1a58f] focus:border-[#9daf8a]"
